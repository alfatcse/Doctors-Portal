...
const ManageDoctors = () => {
    ...
    return (
        <div>
            <h1 className='text-center font-bold mb-3 text-blue-600'>Number of Doctors {doctors?.length}</h1>
                            ...
                            doctors?.map((doctor, i) =>
                                <tr key={doctor._id}>
                                    ...
                                    <td>
                                        {
                                            doctor?.isverified ? <>
                                                <button disabled className='btn btn-primary btn-sm'>Make Verified</button>
                                            </> : <button onClick={() => handleVerified(doctor._id, doctor.specialty)} className='btn btn-primary btn-sm'>Make Verified</button>
                                        }
                                    </td>
                                    <td>
